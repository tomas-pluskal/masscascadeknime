...
public class MsFastDtwNodeFactory extends NodeFactory<MsFastDtwNodeModel> {
	 ...
	 */
	@Override
	public MsFastDtwNodeModel createNodeModel() {
		return new MsFastDtwNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<MsFastDtwNodeModel> createNodeView(final int viewIndex, final MsFastDtwNodeModel nodeModel) {
		return null;
	}
