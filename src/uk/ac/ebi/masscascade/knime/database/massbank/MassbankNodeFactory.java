...
/**
 * <code>NodeFactory</code> for the "Massbank" Node. Spectrum-based Massbank database search.
 * 
 * @author Stephan Beisken
 */
public class MassbankNodeFactory extends NodeFactory<MassbankNodeModel> {
