...
public interface ProfileValue extends DataValue {
	...
	public static class ProfileUtilityFactory extends UtilityFactory {
		...
		private static final Icon ICON = loadIcon(ProfileValue.class, "profile_data.png");
		...
		protected DataValueRendererFamily getRendererFamily(final DataColumnSpec spec) {
			...
			return new DefaultDataValueRendererFamily(new ProfileRenderer("Peak Renderer"));
		}
	}
}
