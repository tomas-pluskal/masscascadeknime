 ...
 */
package uk.ac.ebi.masscascade.knime.datatypes.singleprofilecell;
 ...
 */
public class SingleProfileCell extends BlobDataCell implements StringValue, CollectionDataValue, SingleProfileValue {

	public static final DataType TYPE = DataType.getType(SingleProfileCell.class, DoubleCell.TYPE);
	 ...
	 */
	public SingleProfileCell(final XYZList profileData) {
	...
	protected boolean equalsDataCell(final DataCell dc) {
		...
		if (dc == this)
			return true;
		if (dc instanceof SingleProfileCell)
			return false;

		SingleProfileCell cell = (SingleProfileCell) dc;
	 ...
	 */
	private static class SingleProfileSerializer implements DataCellSerializer<SingleProfileCell> {

		/**
		 * {@inheritDoc}
		 */
		public void serialize(final SingleProfileCell cell, final DataCellDataOutput output) throws IOException {
		 ...
		 * {@inheritDoc}
		 */
		public SingleProfileCell deserialize(final DataCellDataInput input) throws IOException {
			...
			return new SingleProfileCell(data);
		}
	}
