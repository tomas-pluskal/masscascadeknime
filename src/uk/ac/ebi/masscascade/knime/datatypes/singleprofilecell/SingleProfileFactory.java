 ...
 */
public class SingleProfileFactory {

	/**
	 * Type for peak data cells.
	 */
	public static final DataType TYPE = SingleProfileCell.TYPE;

	/**
	 * Don't instantiate this class.
	 */
	private SingleProfileFactory() {
	...
	public static DataCell create(final XYZList profileData) {
		return new SingleProfileCell(profileData);
	}
}
