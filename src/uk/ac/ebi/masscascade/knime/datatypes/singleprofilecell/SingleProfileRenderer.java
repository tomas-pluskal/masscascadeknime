...
public class SingleProfileRenderer extends AbstractPainterDataValueRenderer {

	private final String description;
	private XYZList profileData;

	public SingleProfileRenderer(final String description) {
		this.description = description == null ? "SingleProfileDataCell" : description;
	}

	public void setValue(final Object value) {

		if (value instanceof SingleProfileValue)
			setData(((SingleProfileValue) value).getSingleProfileValue());
		else
			setData(null);
	}
