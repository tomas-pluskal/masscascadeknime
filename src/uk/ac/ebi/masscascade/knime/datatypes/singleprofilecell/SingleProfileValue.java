...
public interface SingleProfileValue extends DataValue {
	...
	public static class SingleProfileUtilityFactory extends UtilityFactory {
		...
		private static final Icon ICON = loadIcon(SingleProfileValue.class, "profile_data.png");
		...
		protected DataValueRendererFamily getRendererFamily(final DataColumnSpec spec) {
			return new DefaultDataValueRendererFamily(new SingleProfileRenderer("Single Profile Renderer"));
		}
	}
}
