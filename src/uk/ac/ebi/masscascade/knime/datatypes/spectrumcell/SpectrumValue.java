...
public interface SpectrumValue extends DataValue {
	...
	public static class SpectrumDataUtilityFactory extends UtilityFactory {
		...
		private static final Icon ICON = loadIcon(SpectrumValue.class, "spectrum_data.png");
		...
		protected DataValueRendererFamily getRendererFamily(final DataColumnSpec spec) {
			...
			return new DefaultDataValueRendererFamily(new SpectrumRenderer("Spectrum Renderer"));
		}
	}
}
