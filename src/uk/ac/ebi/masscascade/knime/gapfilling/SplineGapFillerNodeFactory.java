 ...
 */
package uk.ac.ebi.masscascade.knime.gapfilling;
...
/**
 * <code>NodeFactory</code> for the "SplineGapFiller" Node. Gap filler for extracted ion chromatograms. Natural cubic
 * splines are used to fill gaps in the chromatogram.
 * 
 * @author Stephan Beisken
 */
@Deprecated
public class SplineGapFillerNodeFactory extends NodeFactory<SplineGapFillerNodeModel> {
