...
/**
 * This is the model implementation of SplineGapFiller. Gap filler for extracted ion chromatograms. Natural cubic
...
public class SplineGapFillerNodeModel extends DefaultModel {
	 ...
	 */
	protected SplineGapFillerNodeModel() {

		super(1, 1, CoreTasks.GAP_FILLING.getCallableClass());
	}
