...
/**
 * <code>NodeFactory</code> for the "IonSearch" Node. Searches for the input masses and their adducts/fragments in all
 * peak collections.
 * 
 * @author Stephan Beisken
 */
public class IonSearchNodeFactory extends NodeFactory<IonSearchNodeModel> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public IonSearchNodeModel createNodeModel() {
		return new IonSearchNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<IonSearchNodeModel> createNodeView(final int viewIndex, final IonSearchNodeModel nodeModel) {
		return null;
	}
