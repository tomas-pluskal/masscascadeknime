 ...
 */
public class FeatureConverterNodeFactory extends NodeFactory<FeatureConverterNodeModel> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public FeatureConverterNodeModel createNodeModel() {
		return new FeatureConverterNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<FeatureConverterNodeModel> createNodeView(final int viewIndex,
			final FeatureConverterNodeModel nodeModel) {
		return null;
	}
