 ...
 */
public class ProfileConverterNodeFactory extends NodeFactory<ProfileConverterNodeModel> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public ProfileConverterNodeModel createNodeModel() {
		return new ProfileConverterNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<ProfileConverterNodeModel> createNodeView(final int viewIndex,
			final ProfileConverterNodeModel nodeModel) {
		return null;
	}
