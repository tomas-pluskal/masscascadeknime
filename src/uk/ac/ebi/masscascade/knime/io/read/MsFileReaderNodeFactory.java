...
/**
 * <code>NodeFactory</code> for the "MzFileReader" Node. File reader node for Thermo RAW and PSI mzML mass spectrometry
 * files.
 * 
 * @author Stephan Beisken
 */
public class MsFileReaderNodeFactory extends NodeFactory<MsFileReaderNodeModel> {
