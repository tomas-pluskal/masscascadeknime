...
import uk.ac.ebi.masscascade.parameters.Constants.NORM_METHOD;

/**
 * This is the model implementation of NormalizationNodeModel.
 * 
 * @author Stephan Beisken
 */
public class NormalizationNodeModel extends DefaultModel {

	/**
	 * Constructor for the node model.
	 */
	protected NormalizationNodeModel() {
		super(1, 1, CoreTasks.NORM.getCallableClass());
	}
	...
	protected DataTableSpec[] prepareExecute(final DataTable[] data) throws Exception {
		...
		parameterMap.put(Parameter.NORM_METHOD, NORM_METHOD.TOTAL_SIGNAL);
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		if (settings.getOptionMapSize() == 0) {
			settings.setTextOption(Parameter.NORM_METHOD, "" + Parameter.NORM_METHOD.getDefaultValue());
		}
