 ...
 */
package uk.ac.ebi.masscascade.knime.profilebuilding.tracejoiner;
...
/**
 * This is the model implementation of MassTraceCompiler. Compiles whole chromatogram mass traces from a given set of
 * peaks. Identical masses within a predefined tolerance range are merged into one extracted ion chromatogram.
 * 
 * @author Stephan Beisken
 */
public class MassTraceCompilerNodeModel extends DefaultModel {

	/**
	 * Constructor for the node model.
	 */
	protected MassTraceCompilerNodeModel() {

		super(1, 1, CoreTasks.MASS_TRACE_EXTRACTION.getCallableClass());
	}
