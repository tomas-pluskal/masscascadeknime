...
public class WaveletCompilerNodeModel extends DefaultModel {
	...
	protected DataTableSpec[] prepareExecute(final DataTable[] data) throws Exception {
		...
		parameterMap.put(Parameter.NOISE_INTENSITY, settings.getDoubleOption(Parameter.NOISE_INTENSITY));
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		if (settings.getOptionMapSize() == 0) {
			settings.setTextOption(Parameter.NOISE_INTENSITY, "" + Parameter.NOISE_INTENSITY.getDefaultValue());
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		NodeUtils.validateDoubleGreaterZero(tmpSettings, Parameter.NOISE_INTENSITY);
