 ...
 */
package uk.ac.ebi.masscascade.knime.profileselection.coda;
 ...
 */
public class CodaFilterNodeFactory extends NodeFactory<CodaFilterNodeModel> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public CodaFilterNodeModel createNodeModel() {
		return new CodaFilterNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<CodaFilterNodeModel> createNodeView(final int viewIndex,
			final CodaFilterNodeModel nodeModel) {
		return null;
	}
