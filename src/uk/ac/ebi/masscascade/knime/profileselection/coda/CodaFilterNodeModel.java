 ...
 */
public class CodaFilterNodeModel extends DefaultModel {

	/**
	 * Constructor for the node model.
	 */
	protected CodaFilterNodeModel() {

		super(1, 1, CoreTasks.CODA.getCallableClass());
	}
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		if (settings.getOptionMapSize() == 0) {
			settings.setTextOption(Parameter.CODA, "" + Parameter.CODA.getDefaultValue());
