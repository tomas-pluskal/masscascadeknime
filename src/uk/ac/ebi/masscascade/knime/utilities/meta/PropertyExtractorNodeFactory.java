...
/**
 * <code>NodeFactory</code> for the "PropertyExtractor" Node. Extracts meta information from mass spec data files.
 * 
 * @author Stephan Beisken
 */
public class PropertyExtractorNodeFactory extends NodeFactory<PropertyExtractorNodeModel> {
