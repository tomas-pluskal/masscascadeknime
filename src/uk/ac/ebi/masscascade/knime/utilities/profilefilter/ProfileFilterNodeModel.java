 ...
 */
public class ProfileFilterNodeModel extends DefaultModel {

	/**
	 * Constructor for the node model.
	 */
	protected ProfileFilterNodeModel() {
	...
	protected DataTableSpec[] prepareExecute(final DataTable[] data) throws Exception {
		...
		String[] elementsP = settings.getTextOption(Parameter.PROFILE_RANGE).split("-");
	...
	protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
		...
		if (settings.getOptionMapSize() == 0) {
			...
			settings.setTextOption(Parameter.PROFILE_RANGE, "" + Parameter.PROFILE_RANGE.getDefaultValue());
	...
	protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
		...
		NodeUtils.validateRange(tmpSettings, Parameter.PROFILE_RANGE);
	}
}
