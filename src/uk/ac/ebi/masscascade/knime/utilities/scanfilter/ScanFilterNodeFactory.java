...
/**
 * <code>NodeFactory</code> for the "ScanFilter" Node. Filters scans of a scan collection by retention time and/or m/z.
 * 
 * @author Stephan Beisken
 */
public class ScanFilterNodeFactory extends NodeFactory<ScanFilterNodeModel> {
