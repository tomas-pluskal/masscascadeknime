...
/**
 * <code>NodeFactory</code> for the "BasePeakViewer" Node. Visualises the base peak chromatogram of the selected mass
 * spectrometry run.
 * 
 * @author Stephan Beisken
 */
public class BasePeakViewerNodeFactory extends NodeFactory<ViewerModel> {
