 ...
 */
public class FeatureSetNodeFactory extends NodeFactory<ViewerModel> {
	...
	public ViewerModel createNodeModel() {
		return new ViewerModel(Parameter.FEATURE_SET_COLUMN);
	}
	...
	public NodeView<ViewerModel> createNodeView(final int viewIndex, final ViewerModel nodeModel) {
		return new FeatureSetNodeView(nodeModel);
	}
