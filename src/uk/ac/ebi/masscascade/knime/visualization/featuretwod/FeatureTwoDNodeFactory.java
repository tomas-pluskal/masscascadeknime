...
/**
 * <code>NodeFactory</code> for the "2DViewer" Node. Visualises all profiles as
 * traces in 2D.
 * 
 * @author Stephan Beisken
 */
public class FeatureTwoDNodeFactory extends NodeFactory<ViewerModel> {
	...
	public NodeView<ViewerModel> createNodeView(final int viewIndex, final ViewerModel nodeModel) {
		return new FeatureTwoDNodeView(nodeModel);
	}
