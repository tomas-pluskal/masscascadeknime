 ...
 */
public class ProfileViewerNodeFactory extends NodeFactory<ProfileViewerNodeModel> {

	/**
	 * {@inheritDoc}
	 */
	@Override
	public ProfileViewerNodeModel createNodeModel() {
		return new ProfileViewerNodeModel();
	}
	 ...
	 */
	@Override
	public NodeView<ProfileViewerNodeModel> createNodeView(final int viewIndex, final ProfileViewerNodeModel nodeModel) {
		return new ProfileViewerNodeView(nodeModel);
	}
