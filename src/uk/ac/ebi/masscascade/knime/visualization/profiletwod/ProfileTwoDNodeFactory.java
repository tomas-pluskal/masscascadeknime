...
/**
 * <code>NodeFactory</code> for the "2DViewer" Node. Visualises all profiles as traces in 2D.
 * 
 * @author Stephan Beisken
 */
public class ProfileTwoDNodeFactory extends NodeFactory<ViewerModel> {
	...
	public ViewerModel createNodeModel() {
		return new ViewerModel(Parameter.PEAK_COLUMN, Parameter.SPECTRUM_COLUMN);
	}
