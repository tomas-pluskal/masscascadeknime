...
/**
 * <code>NodeFactory</code> for the "SpectrumViewer" Node. Displays the
 * spectrums from the selected run.
 * 
 * @author Stephan Beisken
 */
public class TicFeatureViewerNodeFactory extends NodeFactory<ViewerModel> {
	...
	public NodeView<ViewerModel> createNodeView(final int viewIndex, final ViewerModel nodeModel) {
		return new TicFeatureViewerNodeView(nodeModel);
	}
